...
<div class="container py-5">
    ...
    <div class="card card-custom p-4">
        ...
        >
            ...
            <div class="col-md-4">
                <label class="form-label" for="PAGI_STATUS">Status</label>
                <select name="PAGI_STATUS" id="PAGI_STATUS" class="form-control"
            ...
            <div class="col-12 d-flex justify-content-end gap-2 mt-4">
                <a type="button" class="btn btn-light border px-4"
                    href="<?= baseUrl() . "{$controller}" ?>"
                >
                    Cancelar
                </a>
