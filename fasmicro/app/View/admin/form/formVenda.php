        ...
        <div class="row g-4">
            <div class="col-lg-5">
                <div class="card card-custom p-4">
                    <form class="row g-3" method="post" action="/venda/<?= $data['data']['action_form'] ?>">
                        <div class="col-12">
                            <label class="form-label small fw-bold">Cliente</label>
                            <select class="form-select bg-light border-0" name="cliente_venda">
                                <!-- Fazer forEach com os clientes para selecionar o cliente $info_venda['PEV_CLIENTE_ID'] -->
            ...
            <div class="col-lg-7">
                <div class="card card-custom p-4">
                    ...
                    <?php if ($id_venda) : ?>
                        <p class="text-muted">Número do Pedido <?= $data['data']['produtos_pedidos'][0]['PEVI_VENDA_ID'] ?></p>
                    <?php endif; ?>
